...
const SidebarItem: React.FC<SidebarItemProp> = ({
  ...
  const bool = location.pathname === sidebardata.Route;
  return (
    <li
      className={`relative flex items-center py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors group ${bool
