...
const ModeChange: React.FC<ModeChangeprop> = ({expanded, className=""}) => {
  ...
  return (
    <div
      className={`relative flex items-center py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors group hover:bg-indigo-300 dark:hover:bg-indigo-700 text-gray-600 dark:text-gray-300 ${className}`} onClick={darkMode.toggle}
    >
